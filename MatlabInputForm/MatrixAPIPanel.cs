...
{
	public class MatrixAPIPanel : APIPanel, IPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.InterleavedTip = new MatlabInputForm.ToolTip();
    ...
    "atlabroot\' at the MATLAB prompt.";
		...
		public new void ShowPanel()
		{
			...
			parent.ClientSize = new System.Drawing.Size(477, 123);
			...
			parent.Name = "MatrixAPIForm";
			parent.Text = "MEX Function Wizard - Matrix API";
